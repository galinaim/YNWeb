...
<div style="height: 100%;">
	...
	<ul>
            ...
            <li class='last'><a href='counseling.php'><span>הדרכות ויעוץ</span></a></li>
                ...
                <div class="jumbotron" style="padding-right: 250px;">
                    <div class="container" style="direction: rtl;">
                        <h2 class='products1'>הדרכות וייעוץ</h2>
                        <p>לחברת יואל נעים בע"מ צוות מקצועי ומנוסה, ובראשו צבי נעים, כימאי אנליטי בעל תואר מהאוניברסיטה העברית בירושלים.</p>
                        <p>בין שירותיה מציעה החברה פגישות ייעוץ והדרכות ללקוחותיה, וכמו כן מבצעת מבדקי איכות לפי דרישה. </p>
                        <p>ההדרכות מועברות ע"י מערך ההדרכות של חברתנו במקום עבודתו של הלקוח.</p>
                        <h2 style="size: 50%;">נושאי ההדרכות אותן ניתן להזמין</h2>
                        <p>שימוש נכון במכשירי פילטרפוטומטר של חברת MACHERY-NAGEL לצורכי בדיקות מים,</p>
                        <p>שימוש נכון בכלי מעבדה במעבדות אנליטיות,</p>
                        <p>זיהוי כלי מדידה תקניים והכרת ההבדלים בין התקנים השונים,</p>
                        <p>הדרכות כיול ואימות כיול.</p>
                        <h2 style="size: 50%;">נושאי פגישות הייעוץ אותן ניתן לקבוע</h2>
                        <p>ניסוח נהלי SOP למעבדות אנליטיות,</p>
                        <p>התאמת מוצרים ופתרונות לבדיקות ובעיות שונות. </p>
                        <br><br>
                        <p><a class="btn btn-primary btn-lg" role="button" href="contact.php" target="_blank">להזמנת הדרכה או קביעת פגישת ייעוץ</a></p>
                    </div>            
                </div>
