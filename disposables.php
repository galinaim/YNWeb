            ...
            <div class="main">
                ...
                <div class="jumbotron">
                    <div class="container" style="direction: rtl">
                        <h2 class='products1'>מוצרים מתכלים</h2>
                        <p>הגדרה: כלל המוצרים החד פעמיים, בין אם סטריליים ובין אם לא, הנמצאים בשימוש שוטף במעבדה.</p>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption" style="height: auto; width: 260px;">
                                            <h3>טיפים לפיפטור</h3>
                                            <p>טיפים PP תוצרת BRAND גרמניה.</p>
                                            <p>הטיפים מיוצרים בחדר נקי וארוזים בתפזורת, בקופסאות PP או במארזי מגשים.</p>
                                            <p>קיימים טיפים Low Retention הידרופוביים במיוחד המאפשרים דיוק מרבי בדגימות בנפחים קטנים.</p>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption" style="height: auto; width: 235px;">
                                            <h3>טיפים לקוצב מנות</h3>
                                            <p>טיפים בצורת מזרק PP בעלי בוכנה PE-HD תוצרת BRAND גרמניה.</p>
                                            <p>הטיפים לקוצב מנות מלווים בתעודת אימות לכל אצווה לפי תקן ISO 8655.</p>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption" style="height: auto; width: 200px;">
                                            <h3>קיווטות</h3>
                                            <p>קיווטות חד פעמיות תוצרת BRAND גרמניה.</p>
                                            <p>קיווטות PS ו-PMMA.</p>
                                            <p>קיווטות UV התואמות קוורץ. מתאימות לעבודה באורכי גל של 220-900 nm.</p>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption" style="height: auto; width: 280px;">
                                            <h3>microplates</h3>
                                            <p>פלטות לשימושים שונים תוצרת BRAND גרמניה.</p>
                                            <p>הפלטות מיוצרות בהתאם לדרישות ANSI-/SLAS standarts 1 to 4 -2004 ומלוות בכל התעודות הנדרשות.</p>
                                            <p><a href="http://www.brand.de/en/downloads-support/brandplatesr-selection-guide/" target="_blank" class="btn btn-primary" role="button">למדריך בחירת הפלטות </a></p>
