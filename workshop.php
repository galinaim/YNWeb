            ...
            <div class="main">
                ...
                <div class="jumbotron">
                    <div class="container" style="direction: rtl">
                        <h2 class='products1'>עבודות בית מלאכה</h2>
                        <p>לרוב המעבדות לא מספיק ציוד הבטיחות הסטנדרטי הנמצא בקטלוגים. הן צריכות מוצרי בטיחות שיותאמו במיוחד עבורן ויענו על צרכיהן המיוחדים.</p>
                        <p>בדיוק לשם מטרה זאת הוקם בית המלאכה של חברות יואל נעים בע"מ ונעים בל-ארט בע"מ!</p>
                        <p>העיקרון המנחה את בית המלאכה הוא נתינת מענה לצרכי הלקוח, והלקוח הינו שותף מלא בתכנון ועיצוב המוצר המבוקש.  </p>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        <img src="images/workshop/standard carts.jpg" alt="עגלות סטנדרטיות" class="prod" style="height:200px; width: 250px;">
                                        <div class="caption" style="height:auto; width: 280px;">
                                            <h3>עגלות סטנדרטיות</h3>
                                            <p>עגלות בטיחותיות בעלות מאצרה לשינוע בטוח של חומרים וציוד.</p>
                            ...
                            <td>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        <img src="images/workshop/special cart.jpg" alt="עגלת שירות" class="prod" style="height:200px; width: 120px; display: inline;">
                                        <img src="images/workshop/divided cart.jpg" alt="עגלה מחולקת" class="prod" style="height:200px; width: 190px; display: inline;">
                                        <img src="images/workshop/tiny cart.jpg" alt="עגלה קטנה" class="prod" style="height:200px; width: 140px; display: inline;">
                                        <div class="caption" style="height: auto; width: 460px;">
                                            <h3>עגלות שירות</h3>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        <img src="images/workshop/carriers.jpg" alt="מנשאים" class="prod" style="height:170px; width: 170px; display: inline;">
                            ...
                            <td>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        <img src="images/workshop/holders.jpg" alt="מאצרה" class="prod" style="height:170px; width: 170px; display: inline;">
                                        <img src="images/workshop/holders2.jpg" alt="מאצרה" class="prod" style="height:100px; width: 220px; display: inline;">
                                        <div class="caption" style="height: auto; width: 415px;">
                                            <h3>מאצרות</h3>
                                            <p>מאצרות PP לאכסון כימיקלים.</p>
                                            <p>המאצרות הינן בהתאם לתקן המשרד להגנת הסביבה.</p>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        <img src="images/workshop/bottle stand.jpg" alt="מעמד לבקבוקים" class="prod" style="height:150px; width: 200px;">
                                        <div class="caption" style="height: auto; width: 300px;">
                                            <h3>מעמדים לבקבוקים</h3>
                            ...
                            <td>
                                ...
                                <div class="col-xs-6 col-md-3" style="height: auto; width: auto;">
                                    <div class="thumbnail">
                                        <img src="images/workshop/stand.jpg" alt="מעמד למכשור" class="prod" style="height:260px; width: 200px;">
                                        <div class="caption" style="height: auto; width: 300px;">
                                            <h3>מעמדים למכשור</h3>
